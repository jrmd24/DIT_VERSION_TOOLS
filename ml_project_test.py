...
class TestMLBackend(unittest.TestCase):
    ...
    def setUp(self):
        ...
        y_reg = X_reg[:, 0] * 2 + X_reg[:, 1] * 1.5 + X_reg[:, 2] * 0.5 + np.random.normal(0, 0.1, 100)
        ...
        self.class_df = pd.DataFrame(X_class, columns=['feature1', 'feature2', 'feature3'])
    ...
    def test_load_data(self):
        ...
        self.assertEqual(list(df_reg.columns), ['feature1', 'feature2', 'feature3', 'target'])
    ...
    def test_build_model(self):
        ...
        classification_models = ["LogisticRegression", "SVC", "RandomForest", "GradientBoosting"]
    ...
    def test_regression_pipeline(self):
        ...
        for model_name in ["Linear", "RandomForest"]:
            request_id, model_path, metrics = mpb.process_client_request(
                self.request_id, "regression", model_name, 
                self.reg_file_path, "target")
    ...
    def test_classification_pipeline(self):
        ...
        for model_name in ["LogisticRegression", "RandomForest"]:
            request_id, model_path, metrics = mpb.process_client_request(
                self.request_id, "classification", model_name,
                self.class_file_path, "target")
    ...
    def test_model_persistence(self):
        ...
        request_id, model_path, _ = mpb.process_client_request(
            self.request_id, "regression", "Linear",
            self.reg_file_path, "target")
